...
for i in range(n):
    ...
    if word not in synonyms_dist:
        synonyms_dist[word] = [synonym]
    elif synonym not in synonyms_dist[word]:
        synonyms_dist[word].append(synonym)

for word, synonyms in synonyms_dist.items():

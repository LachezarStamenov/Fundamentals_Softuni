...
while not command_data == "End":
    ...
    if command == "Shoot":
        ...
        if check_if_index_is_valid(index, len(targets)) and check_if_index_is_valid(left_most_index, len(targets)) and check_if_index_is_valid(left_most_index, len(targets)):

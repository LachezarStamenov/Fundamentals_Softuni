...
# Keep track of the key materials - the first one that reaches 250, wins the race. At that point, you have to print
# that the corresponding legendary item is obtained.
